...
local globalKeys =
  ...
  awful.key( {modkey, 'Shift'}, "s", function () os.execute("systemctl poweroff") end, { description = "Shutdown the System", group = "System" }),
  awful.key( {modkey, 'Shift'}, "r", function () os.execute("systemctl reboot") end,{ description = "Reboot the System", group = "System" }),
